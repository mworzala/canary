...
public class Assertion<T> extends AssertionR<T, Assertion<T>> {



    public static class EntityAssertion<T extends Entity> extends EntityAssertionR<T, EntityAssertion<T>> { }

    public static class LivingEntityAssertion<T extends LivingEntity> extends LivingEntityAssertionR<T, LivingEntityAssertion<T>> { }
}
