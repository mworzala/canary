...
public class CanaryTestExecutorOld {
    private static final Logger logger = LoggerFactory.getLogger(CanaryTestExecutorOld.class);

    private final EngineExecutionListener listener;
    // There must be a better way of handing this
    private Stack<Object> instances = new Stack<>();

    public CanaryTestExecutorOld(EngineExecutionListener listener) {
